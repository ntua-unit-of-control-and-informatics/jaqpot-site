...
| **TORCH_SEQUENCE_ONNX** | predictions | Sequence models (NLP, time series) |
...
for new_dataset in my_research_datasets:
    predictions = jaqpot.predict_local(model_data, new_dataset)
...
results = jaqpot.predict_local(model_data, molecules)
